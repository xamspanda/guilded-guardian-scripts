...
#   Upload to /tmp/payloads/02_sniff_comms.py, then run it with the full Python path:
#     /run/current-system/sw/bin/python3 /tmp/payloads/02_sniff_comms.py [args]
#   If launching through Sliver, use:
#     execute -o /run/current-system/sw/bin/python3 -- /tmp/payloads/02_sniff_comms.py [args]
