...
#   Upload to /tmp/payloads/20_mission_aware_kill.py, then run it with the full Python path:
#     /run/current-system/sw/bin/python3 /tmp/payloads/20_mission_aware_kill.py [args]
#   If launching through Sliver, use:
#     execute -o /run/current-system/sw/bin/python3 -- /tmp/payloads/20_mission_aware_kill.py [args]
